...
<head>
    <meta charset="UTF-8">
    <title>Chamption Plus Sports Bra</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/WomensActiveWear/SportsBra3Front.jpeg" class="d-block w-100"
                             alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/WomensActiveWear/SportsBra3Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Champion Plus Sports Bra</h2>

            <p>Product Code: ISRC6684</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$24.00</p>
