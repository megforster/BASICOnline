<%--
  ...
  Time: 3:14 PM
--%>
%{--One of three kid's tops products page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Belle Du Jour Floral Print Top</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/KidsTops3Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/KidsTops3Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Belle Du Jour Floral Print Top</h2>

            <p>Product Code: ISRC8668</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$33.99</p>

            <p><b>Brand:</b>Belle Du Jour</p>
