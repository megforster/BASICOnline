...
<head>
    <meta charset="UTF-8">
    <title>Hotel Collection Layered Frame Collection</title>
...
<div class="containerProduct">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Hotel Collection Layered Frame Collection</h2>

            <p>Product Code: ISRC6672</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$234.50</p>

            <p><b>Brand:</b>Hotel Collection</p>
