...
<head>
    <meta charset="UTF-8">
    <title>Magnolia Bath Accessory Set</title>
    <!-- Bootstrap CDN-->
...
<div class = "containerProduct">
    <div class = "row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class = "shop-item-image " src="../assets/StockImages/bathAll.jpeg" class="d-block w-100" alt="First Slide">
                    </div>
                    <div class="carousel-item">
                        <img src="../assets/StockImages/bathDispenser.jpeg"  class="d-block w-100" alt="Second Slide">
                    </div>
                    <div class="carousel-item">
                        <img src="../assets/StockImages/bathToothBrush.jpeg"  class="d-block w-100" alt="Third Slide">
                    </div>
                </div>
        ...
        <div class = "col-md-7">
            ...
            <h2 class = shop-item-title>Magnolia Bath Accessory Set</h2>
            <p>Product Code: ISRC5612</p>
            <img src="../assets/StockImages/5stars.png" width="150px">
            <p class = "shop-item-price">$92.78</p>
            <p><b>Brand:</b>Magnolia Bath</p>
            <button type ="button" class="cart shop-item-button">
                <a href="${g.createLink(controller : 'basicOnlineStore', action : 'shoppingCart',params : [])}" onclick="passValues()">
                    Add to Cart
                </a>
            </button>
