...
<head>
    <meta charset="UTF-8">
    <title>Dockers Khaki Stretch Pants</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/MensPants3Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/MensPants3Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Dockers Khaki Stretch Pants</h2>

            <p>Product Code: ISRC4937</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$36.00</p>

            <p><b>Brand:</b>Dockers</p>
