...
%{--One of two women's swimwear products page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Michael Kors Printed Logo Ring Shirred Two-Piece</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/WomensSwim1Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/WomensSwim1Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Michael Kors Printed Logo Ring Shirred Two-Piece</h2>

            <p>Product Code: ISRC6972</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$113.60</p>

            <p><b>Brand:</b>Michael Kors</p>
