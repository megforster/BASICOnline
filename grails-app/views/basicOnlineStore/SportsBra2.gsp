            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/WomensActiveWear/SportsBra2Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/WomensActiveWear/SportsBra2Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
