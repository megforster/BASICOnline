...
<div class = row1>
    ...
    <figure style="margin-left:20px; width:280px; display: inline-block;">
        <a href="${g.createLink(controller : 'basicOnlineStore', action : 'mensRedCoat',params : [])}" style = "text-decoration: none; color:black;"><img src="../assets/StockImages/coatFront.jpeg" alt="Product_coat" hspace="40" width="200"><figcaption style="text-align: center">Hawke and Co Coat</figcaption></a>
    </figure>
</div>
</body>
</html>