...
<head>
    <meta charset="UTF-8">
    <title>PGA Tour Ombré Fade Golf Polo</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/MensTops1Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/MensTops1Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>PGA Tour Ombré Fade Golf Polo</h2>
