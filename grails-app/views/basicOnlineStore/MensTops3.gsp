<%--
  ...
  Time: 1:59 PM
--%>
%{--One of three men's tops products page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Club Room Solid Crewneck T-Shirt</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/MensTops3Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/MensTops3Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Club Room Solid Crewneck T-Shirt</h2>

            <p>Product Code: ISRC7809</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$9.75</p>

            <p><b>Brand:</b>Club Room</p>
