...
%{--Women's dress pants product page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>JM Collection Dress Pants</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/WomensDressPantsFront.jpeg" class="d-block w-100"
                             alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/WomensDressPantsBack.jpeg" class="d-block w-100" alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>JM Collection Women's Dress Pants</h2>

            <p>Product Code: ISRC1170</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$37.13</p>

            <p><b>Brand:</b>JM Collection</p>
