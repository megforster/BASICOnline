<%--
  ...
  Time: 12:33 PM
--%>
%{--One of three decor products page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Braylei Fabric Chaise</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/Decor11.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/Decor12.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Braylei Fabric Chaise</h2>

            <p>Product Code: ISRC0832</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$656.10</p>

            <p><b>Brand:</b>Braylei Fabric</p>
