<%--
  ...
  Time: 3:13 PM
--%>
%{--One of three kid's swim products page--}%
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>First Impressions 2-Pc Great Catch Swim Trunks</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/KidsSwim1Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/KidsSwim1Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>First Impressions 2-Pc Great Catch Swim Trunks</h2>

            <p>Product Code: ISRC2438</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$34.00</p>

            <p><b>Brand:</b>First Impressions</p>
