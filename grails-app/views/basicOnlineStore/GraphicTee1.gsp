<head>
    <meta charset="UTF-8">
    <title>Epic Threads Love Graphic Tee</title>
    <!-- Bootstrap CDN-->
...
<div class = "containerProduct">
    <div class = "row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class = "shop-item-image " src="../assets/StockImages/KidsGraphicTees/Tee1Front.jpeg"  class="d-block w-100" alt="First Slide">
                    </div>
                    <div class="carousel-item">
                        <img src="../assets/StockImages/KidsGraphicTees/Tee1Back.jpeg"  class="d-block w-100" alt="Second Slide">
                    </div>
                </div>
        ...
        <div class = "col-md-7">
            ...
            <h2 class = shop-item-title>Epic Threads Love Graphic Tee</h2>
            <p>Product Code: ISRC2234</p>
