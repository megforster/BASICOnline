...
<div class = row1>
    <figure style="margin-left:20px; width:150px; display: inline-block;">
        <a href="${g.createLink(controller : 'basicOnlineStore', action : 'kidsSneaker',params : [])}" style = "text-decoration: none; color:black;"><img src="../assets/StockImages/side.jpg" alt="Product_sneakers" hspace="40" width="100"><figcaption style="text-align: center">Converse Sneakers</figcaption></a>
    </figure>
