...
<head>
    <meta charset="UTF-8">
    <title>Tommy Hilifigure Ken Tee</title>
...
<div class="containerProduct">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="shop-item-image " src="../assets/StockImages/KidsTops1Front.jpeg"
                             class="d-block w-100" alt="First Slide">
                    </div>

                    <div class="carousel-item">
                        <img src="../assets/StockImages/KidsTops1Back.jpeg" class="d-block w-100"
                             alt="Second Slide">
                    </div>
                </div>
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Tommy Hilifigure Ken Tee</h2>

            <p>Product Code: ISRC5768</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$19.50</p>

            <p><b>Brand:</b>Tommy Hilifigure</p>
