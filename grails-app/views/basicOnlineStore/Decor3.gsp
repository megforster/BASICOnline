...
<head>
    <meta charset="UTF-8">
    <title>Nearly Natural 6' Fiddle Leaf Fig Tree</title>
...
<div class="containerProduct">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <h2 class=shop-item-title>Nearly Natural 6' Fiddle Leaf Fig Tree</h2>

            <p>Product Code: ISRC8602</p>
            <img src="../assets/StockImages/5stars.png" width="150px">

            <p class="shop-item-price">$198.80</p>

            <p><b>Brand:</b>Nearly Natural</p>
